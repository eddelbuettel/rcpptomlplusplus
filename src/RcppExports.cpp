...
RcppExport SEXP _RcppTomlPlusPlus_tomlparseImpl(SEXP inputSEXP, SEXP fromfileSEXP, SEXP escapeSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_RcppTomlPlusPlus_tomlparseImpl", (DL_FUNC) &_RcppTomlPlusPlus_tomlparseImpl, 3},
    {NULL, NULL, 0}
};
